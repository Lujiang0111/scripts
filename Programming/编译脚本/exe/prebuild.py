...
class Prebuild:
    ...
    def Do(self, args) -> None:
        ...
        CreateSoLink(os.path.join(self.__deps_path, "lib"))
    ...
    def __CopyLib(self, lib_name, lib_version) -> None:
        ...
        deps_include_path = os.path.join(self.__deps_path, "include", lib_name)
        RmDir(deps_include_path)
        CopyDir(
